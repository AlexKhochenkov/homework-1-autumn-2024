...
* Кнопка VK ID не работает, так как разработчики убрали свои данные ВК
...
* При вводе и отправке пустого поля "Имя", отображается надпись "Введите имя"
* Если при вводе и отправке поля "Имя ящика" превышает 64 символа, отображается надпись "Слишком длинное имя"
* При вводе и отправке пустого поля "Фамилия", отображается надпись "Введите фамилию"
* Если при вводе и отправке поля "Имя ящика" превышает 64 символа, отображается надпись "Слишком длинная фамилия"
* При вводе и отправке пустого поля "Имя ящика", отображается надпись "Введите имя ящика"
* Если при вводе отправке поля "Имя ящика" превышает 64 символа, отображается надпись "Слишком длинное имя ящика"
...
* При вводе и отправке пустого поля "Пароль", отображается надпись "Введите пароль"
...
* При вводе и отправке пустого поля "Пароль ещё раз", отображается надпись "Введите пароль ещё раз"
...
* При вводе и отправке полей "Дата рождения", где число имеет значение 31, а в выбранном месяце нет такого числа, отображается надпись "В этом месяце нет такого числа"
* При вводе и отправке полей "Дата рождения", где дата имеет значение 30 февраля, отображается надпись "В этом месяце нет такого числа"
...
* При вводе некорректных данных, и последующем нажатии на кнопку "Создать", пользователю выводятся ошибки
* Кнопка VK ID не работает, так как разработчики убрали свои данные ВК
...
* При нажатии на кнопку "Удалить ящик" всплывает плашка "Вы уверены, что хотите удалить ящик?", чтобы пользователь подтвердил действие. Если пользователь подтверждает, то удаляется профиль пользователя и происходит переход на [вкладку "Вход"](https://mailhub.su/login). Если пользователь отказывается, то плашка "Вы уверены, что хотите удалить ящик?" убирается.
